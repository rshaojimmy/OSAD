...
def perturb_iterative(xvar, yvar, predict1, predict2, nb_iter, eps, eps_iter, loss_fn,
...
class PGDAttack(Attack, LabelMixin):
    ...
    def __init__(
            self, predict1, predict2, loss_fn=None, eps=0.3, nb_iter=40,
        ...
        super(PGDAttack, self).__init__(
            predict1, predict2, loss_fn, clip_min, clip_max)
        self.eps = eps
    ...
    def perturb(self, x, y=None):
        ...
        rval = perturb_iterative(
            x, y, self.predict1, self.predict2, nb_iter=self.nb_iter,
